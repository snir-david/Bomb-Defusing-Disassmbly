...
401142:       83 f8 01                cmp    $0x1,%eax  #checking return value number (how much variables return) cmp 1 - if greater moving on
401145:       7f 05                   jg     40114c <phase_3+0x27>
401147:       e8 63 02 00 00          callq  4013af <explode_bomb>
40114c:       83 7c 24 0c 07          cmpl   $0x7,0xc(%rsp) #checking if first value greater than 7 - if 7 > go to explode_bomb
401151:       77 43                   ja     401196 <phase_3+0x71>
401153:       8b 44 24 0c             mov    0xc(%rsp),%eax #eax = second return value from scanf
401157:       ff 24 c5 a0 23 40 00    jmpq   *0x4023a0(,%rax,8) #?
40115e:       b8 c9 03 00 00          mov    $0x3c9,%eax # second input should be 3c9 = 969
